...
function update_canvas() {
    background("white");
    random_number=Math.floor((Math.random()*quick_draw_data_set.lengthen)+1);
    sketch_ran=quick_draw_data_set[random_number];
    document.getElementById("what_you_drawing").innerHTML="Sketch To Be Drawn :"+sketch_ran;
}
function setup() {
